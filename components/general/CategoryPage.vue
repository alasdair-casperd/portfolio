<template>
  <div class="flex flex-col py-24 z-50">
    ...
    <div class="px-4 sm:px-12 mt-24 w-full">
      <div
        class="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-8 gap-2"
      >
      ...
      <div>
        <ResponsiveGrid>
          <NuxtLink
            ...
            :to="category.path"
            class="bg-base-950 border border-base-700 p-2 sm:p-4 rounded-lg flex items-center justify-between"
          >
